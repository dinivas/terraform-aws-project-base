...
module "project_consul_cluster" {
  ...
  consul_cluster_network                      = "${var.project_name}-mgmt"
  consul_cluster_subnet                       = "${var.project_name}-mgmt-subnet"
  ...
  consul_client_instance_count                = "${var.project_consul_server_count}"
